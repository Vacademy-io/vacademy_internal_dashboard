...
// export const GET_QUESTION_PAPER_FILTERED_DATA = `http://localhost:8074/assessment-service/question-paper/public/view/v1/get-with-filters`;
export const MARK_QUESTION_PAPER_STATUS = `${BASE_URL}/assessment-service/question-paper/manage/v1/mark-status`;
export const DELETE_PUBLIC_QUESTION_PAPER = `${BASE_URL}/assessment-service/question-paper/public/manage/v1/delete`;
// export const DELETE_PUBLIC_QUESTION_PAPER = `http://localhost:8074/assessment-service/question-paper/public/manage/v1/delete`;
